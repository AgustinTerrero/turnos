...
export default function DetailsStep({ onSubmit, onBack, defaultValues }: Props) {
  ...
  return (
    <div className="flex justify-center items-center px-2 sm:px-0">
      <form
        className="bg-gradient-to-br from-white to-gray-50 shadow-2xl rounded-2xl sm:rounded-3xl px-5 sm:px-8 md:px-12 py-8 sm:py-12 max-w-lg w-full border-2 border-gray-100"
        onSubmit={e => {
          e.preventDefault();
      ...
      >
        <div className="space-y-5 sm:space-y-6 mb-6 sm:mb-8">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              className="rounded-xl bg-white border-2 border-gray-200 px-4 sm:px-5 py-3 sm:py-4 text-sm sm:text-base focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 transition-all shadow-sm"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                required
                className={`rounded-xl bg-white border-2 px-4 sm:px-5 py-3 sm:py-4 text-sm sm:text-base focus:ring-4 transition-all shadow-sm ${
        ...
        {/* WhatsApp reminder */}
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-4 sm:p-5 mb-6 sm:mb-8">
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <label htmlFor="whatsapp-reminder" className="flex-1 cursor-pointer">
              <div className="flex items-center gap-2 mb-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-4 h-4 sm:w-5 sm:h-5 text-green-600">
                ...
                <span className="text-sm sm:text-base font-semibold text-gray-900">Recordatorio por WhatsApp</span>
              </div>
              <p className="text-xs sm:text-sm text-gray-600">Te enviaremos un mensaje antes de tu turno</p>
            </label>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <Button
            type="submit"
            className="w-full py-3.5 sm:py-4 rounded-xl text-sm sm:text-base font-semibold bg-gradient-to-r from-indigo-600 to-blue-600 text-white hover:from-indigo-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105"
            disabled={!phoneValid || !name}
          >
            Confirmar reserva
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 sm:w-5 sm:h-5 inline ml-2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
            </svg>
          </Button>
          
          {/* Botón volver centrado y más pequeño */}
