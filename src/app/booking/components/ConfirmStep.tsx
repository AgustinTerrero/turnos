...
export default function ConfirmStep({ service, date, time, name, phone, wantsWhatsappReminder, onNew }: Props) {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="bg-gradient-to-br from-white to-gray-50 shadow-2xl rounded-3xl px-8 sm:px-12 py-12 max-w-2xl w-full text-center border-2 border-gray-100">
        {/* Checkmark animado */}
        <div className="flex justify-center mb-6 animate-bounce-in">
          <AnimatedCheckmark size={140} color="#10b981" />
        </div>

        {/* Título de éxito */}
        <div className="mb-8">
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-3 tracking-tight bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">
            ¡Turno confirmado!
          </h1>
          <p className="text-xl text-gray-600 font-medium">Nos vemos pronto 👋</p>
        </div>

        {/* Detalles del turno */}
        <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-6 mb-8 border-2 border-indigo-100">
          <div className="space-y-4">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="text-left flex-1 min-w-0">
                <div className="text-xs text-gray-500 font-medium uppercase">Servicio</div>
                <div className="text-lg sm:text-xl font-bold text-gray-900 break-words">{service}</div>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-white rounded-xl p-3 sm:p-4 border border-indigo-100 min-w-0">
                <div className="text-[10px] sm:text-xs text-gray-500 font-medium uppercase mb-1">Fecha</div>
              ...
              <div className="bg-white rounded-xl p-3 sm:p-4 border border-indigo-100 min-w-0">
                <div className="text-[10px] sm:text-xs text-gray-500 font-medium uppercase mb-1">Hora</div>
                <div className="text-sm sm:text-base md:text-lg font-bold text-gray-900 break-words leading-tight">{time}</div>
              </div>
            </div>

            <div className="bg-white rounded-xl p-4 border border-indigo-100">
              <div className="text-xs text-gray-500 font-medium uppercase mb-1">Contacto</div>
        ...
        <div className="space-y-4 mb-8">
          <a
            ...
            className="flex items-center justify-center gap-3 px-6 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl text-base bg-gradient-to-r from-indigo-600 to-blue-600 text-white transition-all hover:scale-105"
          >
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-4 sm:p-5">
            <div className="flex items-start gap-3 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6 text-green-600 flex-shrink-0 mt-1">
              ...
              <div className="flex-1 text-left min-w-0">
                ...
                <p className="text-green-700 text-xs sm:text-sm mb-3 break-words">Contactanos por WhatsApp y te ayudamos</p>
              </div>
            </div>
            <a
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold shadow-md hover:shadow-lg text-base bg-green-600 hover:bg-green-700 text-white transition-all hover:scale-105"
            >
        ...
        <Button
          onClick={onNew}
          className="w-full py-4 rounded-xl text-base font-semibold bg-gray-100 hover:bg-gray-200 border-2 border-gray-200 text-gray-700 transition-all hover:scale-105"
        >
